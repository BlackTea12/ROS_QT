...
ui_path = "/"+ui_path+"/resources/main_window_thread.ui"
# print(ui_path)
...
class MyROSQtApp(QMainWindow, form_class):
    def __init__(self, app):
        ...
        # self.lineEdit01.editingFinished.connect(self.lineEdit1Finished)
        # self.lineEdit02.editingFinished.connect(self.lineEdit2Finished)
        # self.lineEdit03.editingFinished.connect(self.lineEdit3Finished)
    ...
    # def lineEdit1Finished(self):
    #     value = self.lineEdit01.text()
    #     self.worker.setPosition(x=float(value))

    # def lineEdit2Finished(self):
    #     value = self.lineEdit02.text()
    #     self.worker.setPosition(y=float(value))

    # def lineEdit3Finished(self):
    #     value = self.lineEdit03.text()
    #     self.worker.setObsSize(float(value))
